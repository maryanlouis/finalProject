<?php
	...
	$Query = "SELECT product.*,category.* FROM `category` inner join product on product.category_id = category.category_id";
...
<div class="container">
	...
	?>
		<div class="col-sm-4">
			<div class="thumbnail">
            <a href="addofferline.php?productid=<?php echo $val['product_id']?>"><img
                    ng-src="images/<?php echo $val['img']; ?>.jpg" alt="" /></a>
				<div class="caption">
					<div ng-hide="showDetails === true">
						...
						<p class="label label-primary label-sm">Category Name:<?php echo $val['category_name']; ?></p>
					</div>
				</div>
			</div>
		</div>
